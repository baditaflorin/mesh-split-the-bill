...
Source: **https://github.com/baditaflorin/mesh-split-the-bill**
...
git clone https://github.com/baditaflorin/mesh-split-the-bill
cd mesh-split-the-bill
npm install
npm run dev
```
...
- `mesh-split-the-bill:signalingUrl`
- `mesh-split-the-bill:turnTokenUrl`
- `mesh-split-the-bill:iceServers`
- `mesh-split-the-bill:room`
